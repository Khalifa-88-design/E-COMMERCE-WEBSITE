...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/lexan.png" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/lexan.png" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/lexan.png" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           ...
           <br>
           <p>
            Give your health routine a boost with Lexan medication.
             Take it in the morning for lasting energy, or pair it with a balanced diet for an active and healthy lifestyle. 
           </p>
        </div>
    </div>
</div>
