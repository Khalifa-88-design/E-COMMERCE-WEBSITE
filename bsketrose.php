...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/equazen.png" width="100%" id="ProductImg">
        ...
        <div class="col-2">
           ...
           <br>
           <p>
           Equazen Capsules are clinically researched to help support children and adolescents 5+ years with learning and behavioural concerns. 
           Equazen Capsules have the same key ingredients as the Equazen range.
           </p>
        </div>
    </div>
</div>
