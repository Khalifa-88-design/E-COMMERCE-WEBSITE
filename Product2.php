...
<html lang="en">
    ...
    <div class="small-container">
            ...
            <div class="row">
                <div class="col-4">
                   <a href="Couple2.php"> <img src="Images/de_witt's.png" > </a>
                  <a href="Couple2.php">  <h4>De Witt's</h4> </a>
                    <div class="rating">
            ...
            <div class="row">
                <div class="col-4">
                  <a href="bsketrose2.php"><img src="Images/equazen.png" > </a>
                   <a href="bsketrose2.php"> <h4>Equazen</h4> </a>
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                ...
                <div class="col-4">
                  <a href="ClassicWatch2.php">  <img src="Images/panado.webp" > </a>
                 <a href="ClassicWatch2.php">   <h4>Panado</h4> </a>
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
