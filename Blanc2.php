...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/buscopan.jpeg"  width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/buscopan.jpeg"  width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/buscopan.jpeg"  width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Buscopan Forte</p>
           <h1>Buscopan Forte</h1>
           <h4>R63.25</h4>
           <select >
           ...
           <button class="btn" onclick="addToCart('Buscopan Forte', 63.25)">Add To Cart</button>
           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           Buscopan Forte effectively with InflaMed Pain & Inflammation support for acute and chronic conditions. 
