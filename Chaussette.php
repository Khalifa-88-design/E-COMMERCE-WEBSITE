...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/disprin.webp" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/disprin.webp" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/disprineB.png" width="100%" class="small-img">
            </div>
                <div class="small-img-col">
                    <img src="Images/disprineB.png" width="100%" class="small-img">
                </div>   
        ...
        <div class="col-2">
           ...
           <a href="Account.php" class="btn">Add To Cart</a>
           
           <input type="number" id="product-quantity" value="1">
           <button class="btn" onclick="addToCart('Disprin', 17.87)">Add To Cart</button>
           
           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           Disprin Extra Strength 500mg 24 Tablets is made extra strong with 500mg of aspirin.
            The tablets dissolve easily in the mouth or in water, and get to work fast to reduce a minor aches and pains 
           </p>
        </div>
    </div>
</div>
...
<div class="small-container">
        <div class="row">
          ...
          <a href="SportWatch.php">    <h4>Kiddia</h4></a>  
                <div class="rating">
                    <i class="fa fa-star" ></i>
                    <i class="fa fa-star" ></i>
                    <i class="fa fa-star" ></i>
            ...
            <div class="col-4">
             ...
             <a href="SchoolGirl.php">   <h4>Make Enlargement</h4> </a>
                <div class="rating">
                    <i class="fa fa-star" ></i>
                    <i class="fa fa-star" ></i>
                    <i class="fa fa-star" ></i>
