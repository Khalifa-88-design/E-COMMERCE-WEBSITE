...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/aspirin.jpeg"  width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="Images/aspirin.jpeg"  width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Images/aspirin.jpeg"  width="100%" class="small-img">
                    </div>
           ...
           <button class="btn" onclick="addToCart('Aspirin', 29.99)">Add To Cart</button>
