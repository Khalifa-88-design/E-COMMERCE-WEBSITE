...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/codral.jpeg" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/codral.jpeg" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/codral.jpeg" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Codral cold & flu</p>
           <h1>Codral cold & flu</h1>
           <h4>R69.87</h4>
           <select >
           ...
           <button class="btn" onclick="addToCart('Codral cold & flu', 69.87)">Add To Cart</button>
