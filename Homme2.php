...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/visine.jpeg"  width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/visine.jpeg"  width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/visine.jpeg"  width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Visine Allergy</p>
           <h1>Visine Allergy</h1>
           <h4>R19.33</h4>
           <select >
           ...
           <button class="btn" onclick="addToCart('Visine Allergy', 19.33)">Add To Cart</button>

           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           Stress-Away Tablets are formulated to assist individuals in managing symptoms of anxiety and stress. 
           These tablets are designed for ease of use, with recommended dosage instructions provided to ensure proper usage.
           </p>
        </div>
    </div>
</div>
