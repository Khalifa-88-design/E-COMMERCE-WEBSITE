...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/imodium.jpeg" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/imodium.jpeg" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/imodium.jpeg" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Imodium Multi-symptom Relief </p>
           <h1>Imodium Multi-symptom Relief</h1>
           <h4>R58.00</h4>
           <select >
           ...
           <button class="btn" onclick="addToCart('Imodium Multi-symptom Relief', 58.00)">Add To Cart</button>

           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           KIDDIEFORTE ® is indicated for the treatment of antibiotic-induced diarrhoea and other intestinal disorders in toddlers as well 
           as for the restoration of the naturally occurring bacterial intestinal flora in the toddlers intestinal tract.
           </p>
        </div>
    </div>
</div>
...
<div class="small-container">
        <div class="row">
          ...
          <a href="SportWatch2.php">    <h4>Kiddia</h4></a>  
                <div class="rating">
                    <i class="fa fa-star" ></i>
                    <i class="fa fa-star" ></i>
                    <i class="fa fa-star" ></i>
