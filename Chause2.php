...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/hylands.jpeg"  width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/hylands.jpeg"  width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/hylands.jpeg"  width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Hylands EarAche Drops </p>
           <h1>Hylands EarAche Drops</h1>
           <h4>R17.87</h4>
           <select >
           ...
           <br>
           <p>
           Hylands EarAche Drops 500mg 24 Tablets is made extra strong with 500mg of aspirin.
