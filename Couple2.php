...
<div class="small-container single-product">
    <div class="row">
        ...
        <div class="col-2">
           ...
           <button class="btn" onclick="addToCart('Equazen', 50.00)">Add To Cart</button>


           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
          De Witts are clinically researched to help support children and adolescents 5+ years with learning and behavioural concerns. 
          De Witts  have the same key ingredients as the De Witts range.
           </p>
        </div>
    </div>
</div>
