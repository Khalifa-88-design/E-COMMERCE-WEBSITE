...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/male_enlargement.png" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/male_enlargement.png" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/male_enlargement.png" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           ...
           <br>
           <p>
            Give your summer wardrobe a style upgrade with the AISH Woman's Active 
            JMini-Jupe. Team it with a pair of shorts for your morning without or a denims 
            with for an evening out with the guys. 
           </p>
        </div>
    </div>
</div>
