...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/ibuprofen.jpeg" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/ibuprofen.jpeg"width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/ibuprofen.jpeg" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           ...
           <button class="btn" onclick="addToCart('Ibuprofen', 82.89)">Add To Cart</button>

           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           Ibuprofenis used to treat the symptoms of too much stomach acid
