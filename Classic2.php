...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/re.jpeg" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/re.jpeg" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/re.jpeg" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Recuran Plus Ear Drops</p>
           <h1>Recuran Plus Ear Drops</h1>
           <h4>R74.34</h4>
           <select >
           ...
           <button class="btn" onclick="addToCart('Sudafed', 74.34)">Add To Cart</button>


           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           Recuran Plus Ear Drops which has analgesic and antipyretic actions.
