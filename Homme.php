...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/galpharm.jpeg" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/galpharm.jpeg" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/galpharm.jpeg" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Galpharm Cold & Flu</p>
           <h1>Galpharm Cold & Flu</h1>
           <h4>R19.33</h4>
           <select >
