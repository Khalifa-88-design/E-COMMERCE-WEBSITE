...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/panado.webp" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/panado.webp" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images//panado1.jpg" width="100%" class="small-img">
            </div>
                <div class="small-img-col">
                    <img src="Images/panado2.jpg" width="100%" class="small-img">
                </div>   
                <div class="small-img-col">
                    <img src="Images/panado3.jpg" width="100%" class="small-img">
                    </div>  
        </div>
        ...
        <div class="col-2">
           ...
           <br>
           <p>
           Paracetamol which has analgesic and antipyretic actions.
            This assists with the relief of mild to moderate pain and fever. 
           </p>
        </div>
    </div>
</div>
