...
<html lang="en">
    ...
    <div class="small-container">
            ...
            <div class="row">
                <div class="col-4">
                <div class="col-4" data-price="50.00" data-popularity="5" data-rating="4" data-sale="30">
                   <a href="CoupleProduct.php"> <img src="Images/benylin.jpeg" > </a>
                  <a href="CoupleProduct.php">  <h4>Benylin</h4> </a>
                    <div class="rating">
                ...
                <div class="col-4">
                <div class="col-4" data-price="33.33" data-popularity="5" data-rating="4" data-sale="30">
                 <a href="NikeShoesProduct.php">   <img src="Images/advil.jpeg" > </a>
                  <a href="NikeShoesProduct.php">  <h4>Advil Cold & Flu</h4> </a>
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                ...
                <div class="col-4">
                <div class="col-4" data-price="67.87" data-popularity="5" data-rating="4" data-sale="30">
                   <a href="OpenLeft.php"><img src="Images/codral.jpeg" ></a> 
                  <a href="OpenLeft.php"><h4>Codral Cold & Flu</h4></a>  
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                ...
                <div class="col-4">
                <div class="col-4" data-price="19.33" data-popularity="5" data-rating="4" data-sale="30">
                  <a href="Homme.php">  <img src="Images/galpharm.jpeg" ></a>
                  <a href="Homme.php">  <h4>Galpharm Cold & Flu</h4></a>
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
            ...
            <div class="row">
                <div class="col-4">
                <div class="col-4" data-price="50.00" data-popularity="5" data-rating="4" data-sale="30">
                  <a href="bsket.php"><img src="Images/sinex.jpeg" > </a>
                   <a href="bsket.php"> <h4>Sinex</h4> </a>
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                ...
                <div class="col-4">
                <div class="col-4" data-price="50.00" data-popularity="5" data-rating="4" data-sale="30">
                   <a href="Cuty.php"><img src="Images/advilsinus.jpeg" > </a> 
                    <a href="Cuty.php"><h4>Advil Sinus</h4> </a> 
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                ...
                <div class="col-4">
                   <a href="Chause.php"><img src="Images/equate.jpeg" ></a>
                   <a href="Chause.php"> <h4>Equate</h4></a>
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                ...
                <div class="col-4">
                  <a href="Classic.php">  <img src="Images/sudafed.jpeg" > </a>
                 <a href="Classic.php">   <h4>Sudafed</h4> </a>
                    <div class="rating">
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                        <i class="fa fa-star" ></i>
                ...
                <div class="row">
                    <div class="col-4">
                       <a href="Blanc.php"> <img src="Images/strepsils.jpeg" ></a>
                       <a href="Blanc.php"> <h4>Strepsils</h4></a>
                        <div class="rating">
                            <i class="fa fa-star" ></i>
                            <i class="fa fa-star" ></i>
                            <i class="fa fa-star" ></i>
                    ...
                    <div class="col-4">
                    <a href="Sport.php">    <img src="Images/Cloraseptic.jpeg" ></a>
                     <a href="Sport.php">  <h4>Cloraseptic</h4></a>
                        <div class="rating">
                            <i class="fa fa-star" ></i>
                            <i class="fa fa-star" ></i>
                            <i class="fa fa-star" ></i>
                    ...
                    <div class="col-4">
                     <a href="Alfan.php">  <img src="Images/codralsorethroat.jpeg" > </a> 
                     <a href="Alfan.php">  <h4>Codral sore throat</h4></a> 
                        <div class="rating">
                            <i class="fa fa-star" ></i>
                            <i class="fa fa-star" ></i>
                            <i class="fa fa-star" ></i>
                    ...
                    <div class="col-4">
                      <a href="School.php"> <img src="Images/cepacol.jpeg" ></a> 
                       <a href="School.php"> <h4>Cepacol</h4></a> 
                        <div class="rating">
                            <i class="fa fa-star" ></i>
                            <i class="fa fa-star" ></i>
                            <i class="fa fa-star" ></i>
        ...
        <div class="page-btn">
    <a href="Product2.php"><span>1</span></a>
