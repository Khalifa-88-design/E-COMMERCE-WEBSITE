...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/alaway.jpeg" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/alaway.jpeg" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/alaway.jpeg" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Alaway Eye Relief </p>
           <h1>Alaway Eye Relief</h1>
           <h4>R50.00</h4>
           <select >
           ...
           <button class="btn" onclick="addToCart('Alaway Eye Relief', 50.00)">Add To Cart</button>

           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           Alaway Eye Relief are clinically researched to help support children and adolescents 5+ years with learning and behavioural concerns. 
           Alaway Eye Relief have the same key ingredients as the Equazen range.
           </p>
        </div>
    </div>
</div>
