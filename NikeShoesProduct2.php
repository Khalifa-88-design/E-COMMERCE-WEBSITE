...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/opcon-a.jpeg"  width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/opcon-a.jpeg"  width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/opcon-a.jpeg"  width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           ...
           <button class="btn" onclick="addToCart('Opcon-A', 33.33)">Add To Cart</button>
