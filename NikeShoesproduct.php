...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/advil.jpeg"  width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/advil.jpeg"  width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/advil.jpeg"  width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           <p>Home / Advil Cold & Flu</p>
           <h1>Advil Cold & Flu</h1>
           <h4>R33.33</h4>
           <select >
           ...
           <button class="btn" onclick="addToCart('Advil Cold & Flu', 33.33)">Add To Cart</button>

           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           Advil Multi-Symptom Cold & Flu relieves your worst cold and flu symptoms, including nasal swelling with just one pill, so you can power through your day.
           </p>
        </div>
    </div>
</div>
