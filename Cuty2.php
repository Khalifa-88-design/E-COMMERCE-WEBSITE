...
<head>
    ...
    <title>Product details - HEDR CARE</title>
...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/similasan.jpeg" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="Images/similasan.jpeg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Images/similasan.jpeg" width="100%" class="small-img">
                    </div>
            ...
            <div class="col-2">
                <p>Home /Similasan kids Ear </p>
                <h1>Similasan kids Ear</h1>
                <h4>R25.99</h4>
                <select>
           ...
           <button class="btn" onclick="addToCart('Similasan kids Ear', 25.99)">Add To Cart</button>


                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>
                    Similasan kids Ear is used to relieve mild to moderate pain from a headache, toothache
                    , cold, flu, joint pain, or periods pain.
                </p>
            </div>
        </div>
    </div>
