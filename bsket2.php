...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="Images/alissa.jpeg" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="Images/alissa.jpeg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="Images/alissa.jpeg" width="100%" class="small-img">
                    </div>
            ...
            <div class="col-2">
                ...
                <button class="btn" onclick="addToCart('Alissa Healthcare', 63.25)">Add To Cart</button>
                <h3>Product Details <i class="fa fa-indent"></i></h3>
                <br>
                <p>
                    Alissa Healthcare are clinically researched to help support children and adolescents 5+ years with learning and behavioural concerns.
                    Alissa Healthcare  have the same key ingredients as the Equazen range.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="small-container">
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="SchoolGirl2.php">
                    <h4>Make Enlargement</h4>
                </a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
