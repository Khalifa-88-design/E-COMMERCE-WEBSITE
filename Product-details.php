...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/de_witt's.png" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/de_witt's.png" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/de_witt's.png" width="100%" class="small-img">
            </div>
        ...
        <div class="col-2">
           ...
           <br>
           <p>
           De witts pills is a herbal remedy which is traditionally used to increase the formation of urine, 
           a diuretic with mild antiseptic action. These pills by de witts aids in alleviating muscular aches and pains, headache, getting up at nights, 
           loss of energy if caused by sluggish kidneys.
