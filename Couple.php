    ...
    <div class="row">
        ...
        <div class="small-img-row">
             ...
             <div class="small-img-col">
                ...
                <div class="small-img-col">
                    <img src="Images/equazen.png" width="100%" class="small-img">
                </div>   
                <div class="small-img-col">
                    <img src="Images/de_witt's.png"  width="100%" class="small-img">
                    </div>  
        ...
        <div class="col-2">
           ...
           <br>
           <p>
           De Witt Capsules are clinically researched to help support children and adolescents 5+ years with learning and behavioural concerns. 
           De Witt Capsules have the same key ingredients as the DE Witt range.
           </p>
        </div>
    </div>
</div>
