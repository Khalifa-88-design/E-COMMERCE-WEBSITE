...
<div class="small-container single-product">
    <div class="row">
        <div class="col-2">
        <img src="Images/optrex.jpeg" width="100%" id="ProductImg">

        <div class="small-img-row">
             <div class="small-img-col">
             <img src="Images/optrex.jpeg" width="100%" class="small-img">
             </div>
             <div class="small-img-col">
                <img src="Images/sinoxit.png" width="100%" class="small-img">
            </div>
                <div class="small-img-col">
                    <img src="Images/optrex.jpeg" width="100%" class="small-img">
                </div>   
        ...
        <div class="col-2">
           <p>Home / Optrex Actimist</p>
           <h1>Optrex Actimist</h1>
           <h4>R69.87</h4>
           <select >
           ...
           <button class="btn" onclick="addToCart('Optrex Actimist', 69.87)">Add To Cart</button>

           <h3>Product Details  <i class="fa fa-indent"></i></h3>
           <br>
           <p>
           AR (Allergic Rhinitis) poses a significant global health problem. It is the most common form of non-infectious rhinitis,
            affecting 10 to 30% of all adults and up to 40% of children. From Epidemiological studies, the worldwide incidents of AR continue to increase.
           </p>
        </div>
    </div>
</div>
